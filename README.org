...
Here are keybindings to start. Leader key is ~C-SPC~. So go a bible reference is ~Control + Spacebar~, then ~b~, and ~f~, put Acts 2:38. The ta-da! you should be at Acts 2:38.

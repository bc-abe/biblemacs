...
#+begin_src emacs-lisp
  ...
  "bf" '(bm/biblefind :which-key "Bible Search")
  "bs" '(bm/biblesearch :which-key "Bible Search")
...
(setq org-publish-project-alist
      '(("main"
         ...
         :publishing-directory "~/biblemacs/public/"
         :section-numbers nil
         :with-toc nil
         :base-extension "org"
...
(with-eval-after-load 'org
  (define-key org-mode-map (kbd "M-m") #'forward-sentence)
  (define-key org-mode-map (kbd "M-M") #'backward-sentence))
...
(defun bm/biblesearch (regexp)
  "Search REGEXP in all .org files under ~/biblemacs/bible."
  (interactive "sSearch Bible .org files for (regexp): ")
  (let ((default-directory (expand-file-name "~/biblemacs/org/bible/")))
    (rgrep regexp "*.org" default-directory)))
...
(custom-set-variables
 ...
 '(safe-local-variable-values '((eval refresh-org-target-overlays))))
(custom-set-faces
